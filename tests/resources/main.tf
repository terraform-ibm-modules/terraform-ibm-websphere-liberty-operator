  ...
  override_json_string = <<EOF
{
  ...
  "appid": {
    ...
    "name": "appid",
    "resource_group": "wsslz-service-rg",
    "use_appid": false,
    "use_data": false
  },
  "atracker": {
  ...
  "clusters": [
    {
      "boot_volume_crk_name": "wsslz-roks-key",
      "cos_name": "cos",
      "entitlement": null,
      "kms_config": {
        "crk_name": "wsslz-roks-key",
      ...
      "resource_group": "wsslz-management-rg",
      "subnet_names": [
        "vsi-zone-1",
        "vsi-zone-2",
        "vsi-zone-3"
    ...
    },
    {
      ...
      "resource_group": "wsslz-workload-rg",
      "subnet_names": [
        "vsi-zone-1",
        "vsi-zone-2",
        "vsi-zone-3"
  ...
  "resource_groups": [
    {
      "create": true,
      "name": "wsslz-service-rg",
      "use_prefix": false
    },
    {
      "create": true,
      "name": "wsslz-management-rg",
      "use_prefix": false
    },
    {
      "create": true,
      "name": "wsslz-workload-rg",
      "use_prefix": false
    }
  ],
  "secrets_manager": {
  ...
  "transit_gateway_resource_group": "wsslz-service-rg",
