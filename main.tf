...
locals {
  ...
  websphere_liberty_operator_sampleapp_image_tag_digest = "latest@sha256:91589e8e215d416595b045c739724385ffe34364df06d36794dca0d6964053e7" # datasource: icr.io/appcafe/open-liberty/samples/getting-started
}
